...
for k in variables:
    sb.displot(df_re[k])
    mpl.savefig("C:/Users/domingosdeeularia/Documents/notyourbusiness/CodingAndAnalytics/Projects/RealEstateValuation/{0}_displot.png". format(k))
    mpl.close()
...
for i in variables:
    mpl.figure()
    sb.kdeplot(df_re[i])
    mpl.savefig("C:/Users/domingosdeeularia/Documents/notyourbusiness/CodingAndAnalytics/Projects/RealEstateValuation/{0}_kdeplot.png". format(i))
    mpl.close()    
...
mpl.close()
    ...
    outliers using the imputation technique
    """
